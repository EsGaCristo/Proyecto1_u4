...
class UpdateVehiculo extends StatefulWidget {
  const UpdateVehiculo({Key? key}) : super(key: key);
...
class _UpdateVehiculoState extends State<UpdateVehiculo> {
  ...
  Widget build(BuildContext context) {
    ...
    departamentoController.text = arguments['depto'];
    SERIEController.text = arguments['numeroserie'];
    placaController.text = arguments['placa'];
    responsableController.text = arguments['resguardadopor'];
    tanqueController.text = arguments['tanque'].toString();
    _selectedFuelType = arguments['combustible'];
    _selectedType = arguments['tipo'].toString();
        ...
        children: [
          ...
          FilledButton( //actualizar
              onPressed: () async {
                ...
                await updateVehiculo(arguments['id'],veh).then((value) => {
                      if (value > 0)
                        {
